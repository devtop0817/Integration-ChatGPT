...
// Chat with LIVIA routes
Route::get('/chat', 'ChatController@index')->middleware('verified')->name('chat');
Route::post('/chat/ask', 'ChatController@sendChatGPTMessage')->middleware('verified')->name('chat.ask');
Route::post('/chat/topic/create', 'ChatController@createTopic')->middleware('verified')->name('chat.createTopic');
